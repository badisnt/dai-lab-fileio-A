...
public class FileReaderWriter {
    ...
    public boolean writeFile(File file, String content, Charset encoding) {
        ...
        try(OutputStream outputStream = new FileOutputStream(file); OutputStreamWriter writer = new OutputStreamWriter(outputStream, encoding); BufferedWriter bufferedWriter = new BufferedWriter(writer))
        return false;
    }
}
